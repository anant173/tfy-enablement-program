...
def track_experiment(ml_repo: str, model, model_schema: Dict[str, str],params: Dict[str, str], metrics: Dict[str, Union[int, float]]):
    ...
    model_version = run.log_model(
        ...
        framework=SklearnFramework(
            model_filepath="classifier.joblib",
...
def train_model(n_neighbors: int, weights: str, ml_repo: str):
    ...
    model_schema = sklearn_infer_schema(
        model_input=X_test, model=classifier, infer_method_name="predict"
        )
